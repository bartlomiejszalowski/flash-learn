  ...
  return (
    <div className="pt-6">
      ...
      <p className="text-sm text-gray-600">
        Pamiętaj, że za ukończenie każdego trybu otrzymujesz określoną ilość
        punktów. Ilość punktów zależy od poziomu trudności trybu - im
        trudniejszy tryb, tym więcej punktów!
      </p>
    </div>
  );
};
